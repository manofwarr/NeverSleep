!function(A, e) {
    ...
    return function(A) {
        ...
        function B(g) {
            ...
            return A[g].call(E.exports, E, E.exports, B),
            E.l = !0,
            E.exports
        }
        return B.m = A,
        ...
        B.t = function(A, e) {
            if (1 & e && (A = B(A)),
            8 & e || 4 & e && "object" == typeof A && A && A.__esModule)
                return A;
        ...
        var g = function() {
          ...
          , C = E.mp4
          , Q = function() {
            return "undefined" != typeof navigator && 10 > parseFloat(("" + (/CPU.*OS ([0-9_]{3,4})[0-9_]{0,1}|(CPU like).*AppleWebKit.*Mobile/i.exec(navigator.userAgent) || [0, ""])[1]).replace("undefined", "3_2").replace("_", ".").replace("_", "")) && !window.MSStream
        }
          , n = function() {
          ...
          , I = function() {
            function A() {
                ...
                n()) {
                    ...
                    Q() ? this.noSleepTimer = null : (this.noSleepVideo = document.createElement("video"),
            ...
            return g(A, [{
                ...
                value: function() {
                    var A = this;
                    return n() ? navigator.wakeLock.request("screen").then(function(e) {
                        A._wakeLock = e,
                        A.enabled = !0,
                ...
                value: function() {
                    ...
                    this._wakeLock = null) : Q() ? this.noSleepTimer && (console.warn("\n          NoSleep now disabled for older iOS devices.\n        "),
